...
datstr: Decentralized Alternative Templates and Shares Transmitted by Relays. Miner-built
templates, signed JSON wire, Solid documents, Nostr identity. Mining in the browser: a coordinator is a
